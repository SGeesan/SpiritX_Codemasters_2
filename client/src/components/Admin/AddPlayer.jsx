...
import { Button, TextInput, Label, Checkbox, Modal } from "flowbite-react";
...
const AddPlayerModal = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal show={isOpen} onClose={onClose} size="3xl">
      <Modal.Header className="bg-[#f5f5f5] border-b border-indigo-100">
      ...
      <Modal.Body className="bg-[#f5f5f5]">
        {message && (
          <div
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="mt-8 flex gap-3">
            <Button
              color="light"
              onClick={onClose}
              className="w-1/3 h-12 text-lg font-medium border border-gray-300"
            >
              Cancel
            </Button>
            <Button
              type="submit"
              className="w-2/3 h-12 text-lg font-medium bg-[#000000] hover:bg-[#bf0000] border-none"
            >
...
const ParentComponent = () => {
  ...
  return (
    <div>
      <Button onClick={() => setIsModalOpen(true)} className="bg-[#bf0000]">
        Add New Player
      </Button>
